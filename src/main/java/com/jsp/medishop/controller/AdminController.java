...
public class AdminController {
	...
	public ResponseStructure<Admin> loginAdminByEmailAndPassword(@RequestBody Admin admin){
	...
	public ResponseEntity<String> verifyMedicineStatusByAdminController(@PathVariable int medicineId,@PathVariable int vendorId) {
		return medicineService.verifyMedicineStatusByAdminSetrvice(medicineId, vendorId);
